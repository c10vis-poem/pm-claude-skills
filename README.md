...
**v62.2.0 — the distribution wave:** **[SkillScan](mcp-remote/)** (the security scan as a free service for anyone's SKILL.md), **[opt-in usage telemetry](docs/TELEMETRY.md)** (counts, never content), **[SkillBench v2](skillbench/tasks-v2.json)** (deterministic ground-truth checks + cross-family judge panels), the **[starter-pack quiz](https://mohitagw15856.github.io/pm-claude-skills/starter-pack.html)**, the **[Wall of Wins](https://mohitagw15856.github.io/pm-claude-skills/wins.html)**, a **[WhatsApp bot](integrations/whatsapp/)** + **[Apple Shortcuts](integrations/shortcuts/)**, and honest **[glossary](https://mohitagw15856.github.io/pm-claude-skills/what-are-agent-skills.html)** / **[comparison](https://mohitagw15856.github.io/pm-claude-skills/compare.html)** pages. *Earlier — v62.1, nine frontiers* (MCP Apps widgets, the update bot, shared sessions, Telegram, local-model tier); *v62.0, adopt-a-profession.* Full history: **[CHANGELOG](CHANGELOG.md)** · [releases](https://github.com/mohitagw15856/pm-claude-skills/releases)
